...
import com.example.teacher.retrofit.fragments.NavigationDrawerFragment;
...
public static class PlaceholderFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView;
        Log.d("SECTION", getArguments().getInt(ARG_SECTION_NUMBER, -1) + "");
        if(getArguments().getInt(ARG_SECTION_NUMBER, -1) == 1) {
            ...
            pager.setAdapter(new FragmentsAdapter(getActivity().getSupportFragmentManager()));
    ...
    public void onAttach(Activity activity) {
        ...
        ((ActionBarTabsActivity) activity).onSectionAttached(
